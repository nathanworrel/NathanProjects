...
public class ApiBaseUrls
{
    ...
    private static readonly string RemotePort = "127.0.0.1";
    ...
    private static readonly Dictionary<Api, string> ApiToRemotePort = new Dictionary<Api, string>()
    {
        { Api.GetData, "1" },
        { Api.MakeTrade, "1" },
        { Api.CharlesSchwab, "1" },
    ...
    public static string BaseUrl(string environment, Api api)
    {
        ...
        {
            return $"http://{RemotePort}:{ApiToRemotePort[api]}/";
        }
