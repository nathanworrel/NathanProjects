...
namespace WebApi.UpdateTrades.Contexts;

public class UpdateTradesContext : DbContext
{
    public DbSet<Strategy> strategies { get; set; }
    public DbSet<Trade> Trades { get; set; }
    private IWebHostEnvironment _env;

    public UpdateTradesContext(DbContextOptions<UpdateTradesContext> options, IWebHostEnvironment environment) : base(options)
    {
        _env = environment;
    }
